...
/**
 * Class that represents the Classic Scrabble game.
 * 
 * Board Size: 15 cells
 * Players: 2-4
 ...
 * @version 1.0
 */
public class ClassicScrabble extends Game{



	public ClassicScrabble(int boardSize, int rackSize, Locale locale, String dstBdlPath, String ptsBdlPath, String albBdlPath) {
	...
	public static void main(String[] args){
		...
		ClassicScrabble newGame = new ClassicScrabble(boardSize, rackSize, locale, dstBdlPath, ptsBdlPath, albBdlPath);
		newGame.play();	
	}
	...
	protected void play() {
		...
		game.setTitle("Classic Scrabble");
	}
}