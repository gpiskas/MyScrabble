...
/**
 * Class that represents the Double Scrabble game.
 * 
 * Board Size: 15 cells
 * Players: 2-4
 * Player's rack size: 7 letters
 * Bundles:
 * -scrabble.localization.AlphabetDistributionDouble
 ...
 * @version 1.0
 */
public class DoubleScrabble extends Game{



	public DoubleScrabble(int boardSize, int rackSize, Locale locale, String dstBdlPath, String ptsBdlPath, String albBdlPath) {
	...
	public static void main(String[] args){
		...
		String dstBdlPath=new String("scrabble.localization.AlphabetDistributionDouble");	 //double scrabble
		...
		DoubleScrabble newGame = new DoubleScrabble(boardSize, rackSize, locale, dstBdlPath, ptsBdlPath, albBdlPath);
		newGame.play();
	}
