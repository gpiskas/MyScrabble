...
/**
 * Class that represents the Minimum Scrabble game.
 * 
 * Board Size: 15 cells
 * Players: 2-4
 ...
 * Default Rules, except winner is the player with the less points.
 * 
 * 
 * @author George Piskas
 * @version 1.0
 */
public class MinimumScrabble extends Game{



	public MinimumScrabble(int boardSize, int rackSize, Locale locale, String dstBdlPath, String ptsBdlPath, String albBdlPath) {
	...
	public static void main(String[] args){
		...
		MinimumScrabble newGame = new MinimumScrabble(boardSize, rackSize, locale, dstBdlPath, ptsBdlPath, albBdlPath);
		newGame.play();	
	}
	...
	protected void play() {
		...
		game.setTitle("Minimum Scrabble");
	}
}